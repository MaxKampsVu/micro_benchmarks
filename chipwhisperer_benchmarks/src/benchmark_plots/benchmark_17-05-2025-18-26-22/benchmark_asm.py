...
benchmarks = {"sram-overwrite-ld-one-share": sram_overwrite_ld_one_share,
              "sram-overwrite-ld": sram_overwrite_ld,
              "sram-overwrite-ld-zero": sram_overwrite_ld_zero}
